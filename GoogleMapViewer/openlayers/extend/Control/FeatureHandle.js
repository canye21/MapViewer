OpenLayers.Control.FeatureHandle = OpenLayers.Class(OpenLayers.Control, {

    EVENT_TYPES: ['featureClick', 'featureMouseMove', 'featureMouseOver', 'featureMouseOut'],
    ...
    */
    ...
    clickFeature: function (feature) {
        ...
        var px = new OpenLayers.Pixel(evt.layerX, evt.layerY);
        var lonlat = this.map.getLonLatFromLayerPx(px);

        this.events.triggerEvent("featureClick", {
            feature: feature,
    ...
    */
    ...
    CLASS_NAME: "OpenLayers.Control.FeatureHandle"
});