    ...
    dragVertex: function(vertex, pixel) {
        ...
        */
        if (this.feature.geometry.CLASS_NAME == "OpenLayers.Geometry.Point") {
            ...
            if (this.feature.layer.features.length > 3) {
                var components = this.feature.geometry.components;
                for (var i = this.feature.geometry.components.length - 2; i > 0; i--) {
                    var point = components[i];
                    if (point.x == vertex.geometry.x && point.y == vertex.geometry.y)
                        continue;
                    this.feature.layer.features = this.feature.layer.features.del(i);
                    this.feature.geometry.components = this.feature.geometry.components.del(i);
                }
            }
